...
u8 cursor;                       // ASCII 127
int volatile *fb;                // frame buffer
u8 *font;                        // font bitmap 
int row, col;                    // y, x coordinates
int color;                       

extern char _binary_font0_start; // font bitmap start address
...
int fbuf_init()
{
  ...
  ******** yet to figure out HOW TO use these palletes *************/
  ...
  font = &_binary_font0_start; // font bitmap start address
